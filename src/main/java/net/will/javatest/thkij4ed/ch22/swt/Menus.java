/**
 * @(#)Menus.java - Will's practices of Project javatest.
 */
...
import net.will.javatest.thkij4ed.ch18.TextFile;
...
public class Menus implements SWTApplication {
	...
	public void createContents(Composite parent) {
		...
		Set<String> words = new TreeSet<String>(new TextFile("Menus.java",
				"\\W+"));
